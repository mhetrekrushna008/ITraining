...
A=['Viresh','Tukaram','Siddeshwar','Dattatray','Shubham','abc',64,44,29,66,00]
...
B=("Tukaram","Dattatray","Viresh","Siddeshwar","Shubham","abc","Amit",64,44,29,0)
...
print("Count of Tukaram is :",B.count('Tukaram'))

print("Index of Tukaram",B.index('Tukaram'))
